...
# from .multihead_attention_ca import MultiheadAttention
from .multihead_attention_sa_non import MultiheadAttention_sa_non
import math


class Self_TransformerEncoder_non(nn.Module):
    """
...
class TransformerEncoderLayer(nn.Module):
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def __init__(self, embed_dim, num_heads=4, attn_dropout=0.1, relu_dropout=0.0, res_dropout=0.1):
        ...
        self.self_attn = MultiheadAttention_sa_non(
        ...
        self.fc1 = Linear(self.embed_dim, 8* self.embed_dim)   # The "Add & Norm" part in the paper
    ...
    def forward(self, x, x_k=None, x_v=None, mask=None):
        ...
        # x = self.self_attn(query=x, key=x_k, value=x_v, attn_mask=mask) # x == x_k == x_v
...
if __name__ == '__main__':
    encoder = Self_TransformerEncoder_non_2(300, 4, 2)
