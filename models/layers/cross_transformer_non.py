...
from .multihead_attention_ca_non import MultiheadAttention_non
import math


class Cross_TransformerEncoder_non(nn.Module):
    """
...
class TransformerEncoderLayer(nn.Module):
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def __init__(self, embed_dim, num_heads=4, attn_dropout=0.1, relu_dropout=0.0, res_dropout=0.1):
        ...
        self.self_attn = MultiheadAttention_non(
...
if __name__ == '__main__':
    encoder = Cross_TransformerEncoder_non_2(300, 4, 2)
