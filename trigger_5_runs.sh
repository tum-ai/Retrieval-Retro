...
mkdir -p logs
nohup python main_Retrieval_Retro.py --seed 42 --difficulty easy --checkpoint_path checkpoints/RR/easy/epoch150_top5_acc_0.6567_42.pt >> logs/run_easy_seed42.log 2>&1 &
nohup python main_Retrieval_Retro.py --seed 42 --difficulty medium --checkpoint_path checkpoints/RR/medium/epoch350_top5_acc_0.4305_42.pt >> logs/run_medium_seed42.log 2>&1 &
