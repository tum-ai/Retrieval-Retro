...
def parse_args():
    ...
    parser.add_argument("--t_layers_sa", type=int, default=1, help="The number of Transformer layers for Self-Attention")
    parser.add_argument("--head", type=int, default=1, help="The number of attention heads in Transformer ")
    ...
    parser.add_argument("--embedder", type=str, default="Retrieval_Retro", help="Embedding appraoch to use")
    parser.add_argument("--input_dim", type=int, default=200, help="Composition embedding dimension, i.e. number of features of the composition representation")
    parser.add_argument("--hidden_dim", type=int, default=256, help="Dimension in the Transformer Layers of Retrieval_Retro")
    parser.add_argument("--output_dim", type=int, default=256, help="i.e. the number of potential precursors")
